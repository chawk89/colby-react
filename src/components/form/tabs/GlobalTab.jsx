  ...
  return (
    <div className="w-full">
      <Card className="w-full mb-2">
        <h3 className="w-full text-xl font-bold mb-2">Main</h3>
      ...
      <Card className="w-full">
        <h3 className="w-full text-xl font-bold mb-2">Title</h3>
      ...
      <Card className="w-full mt-2">
        <h3 className="w-full text-xl font-bold mb-2">Datasets</h3>
        <div className="w-full grid grid-cols-3 gap-4 px-8">
          <div className="col-span-1">
            <div className="flex items-center">
              <Label
                className="inline mr-2"
                htmlFor="globalXAxisSelect"
                value="X-Axis Dataset:"
              />
          ...
          <div className="col-span-2">
            <div className="flex items-center">
              <div className="flex items-center">
                <Label
                  className="inline mr-2"
                  htmlFor="plotted-datasets"
                  value="Plotted Datasets:"
                />
                <div className="flex gap-3">
                  {keyLabels.map(
                    ({ key, label }) =>
                      key != xAxis && (
                        <div key={key}>
                          <Checkbox {...register(`global.yAxis.${key}`)} />{" "}
                          <Label value={label} />{" "}
                        </div>
                      )
                  )}
          ...
          <div className="col-span-1">
            <div className="flex items-center">
              <Label
                ...
                value="Data Range:"
              />
              <ColbyTextInput type="text" control={control} name="dataRange" />
            </div>
          </div>
        </div>
      </Card>
      <Card className="w-full mt-2">
        <h3 className="w-full text-xl font-bold mb-2">Legend</h3>
        <div className="w-full grid grid-cols-3 gap-4 px-8">
          <div className="col-span-1">
            <div className="flex items-center">
              <Controller
